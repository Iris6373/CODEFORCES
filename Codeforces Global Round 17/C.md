...
## My solution :  (Accepted)
     ...
     We check greedily using binary Search.
   ...
   ### Code : (.cpp)  
          ...
          bool chk(vt a, vt b, ll mid) {
              ll i, cnt = 0, rich = mid-1, poor = 0;
              f(sz(a)) {
                  if (a[i] >= rich && b[i] >= poor) rich--, poor++, cnt++;
              }
              return cnt >= mid;
          }
          ...
          void solve() {  
              ll i, j, k, m, n, c=0, d=0, e=0, f=0, w=0, x=0, y=0, z=0, ans=0;
              string s;
              cin >> n;
              vt a(n), b(n);
              f(n) {
    ...
    Time Complexity  : O(t*n*logn)
                       t test cases
                       Each test case takes O(n*logn) time. 
