...
## [C. Two Arrays](https://codeforces.com/contest/1589/problem/C)


## My solution :  (Accepted)

      A can only be converted to B iff all elements in A are either equal or 1 less than in B
