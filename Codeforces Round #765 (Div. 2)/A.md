...
## My solution :  (Accepted)
   ...
   ### Code : (.cpp)  
          ...
          void solve() {  
              ll i, j, k, m, n, a=INT_MAX, b=0, c=0, d=0, e=0, f=0, w=0, x=0, y=0, z=0, ans = 0;
              string s;
              cin >> n >> b;
              vector<bitset<32>> v;
              bitset<32> btt;
    ...
    Time Complexity  : O(t*l*n)
                       t test cases
                       Since for test case we check all 32 bits for all n numbers.

    Space Complexity : O(n)  
                       Since we use bitset to store numbers in binary form.
